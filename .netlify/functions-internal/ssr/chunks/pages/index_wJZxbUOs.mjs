/* empty css                          */
import { d as createAstro, c as createComponent, r as renderTemplate, m as maybeRenderHead, e as addAttribute, f as renderComponent, h as renderHead, g as renderSlot } from '../astro_BD0Lb4GF.mjs';
import 'kleur/colors';
import { e as $$SEO, g as $$ViewTransitions, h as $$BodyLayout, a as $$BannerTitleSeparator, G as GetTheMostRecentBlogs, d as $$PreviewPanel, $ as $$Index$3 } from './_page__BKngyi8y.mjs';
/* empty css                                 */
import { $ as $$ResponsiveImage, c as $$EliHeadshot, d as $$Version2 } from './criminal-defense-law_BTKa5YW1.mjs';
import 'clsx';
...
const $$Panel = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<div role="listitem" class="md:w-[300px] min-[992px]:w-[375px] 2xl:w-[468px] h-full md:min-w-[280px] lg:min-w-[270px]"> <div class="practice-area-item h-auto hover:bg-slate-700 transition-all duration-1000"> <div class="practice-listing-content-wrap !pb-[40px]"> <div class="h-[110px]"> <a${addAttribute(url, "href")} class="practice-area-title">${type}</a> </div> <p class="h-[235px] md:h-[300px] min-[991px]:h-[250px] max-h-[250px]">${description}</p> </div> <div class="grid [&>div]:mx-auto mb-0 mt-auto text-center sm:flex sm:flex-row sm:align-start"> <div class="mx-auto w-[53px] min-[788px]:w-[53px] sm:mt-[20px]"> <img${addAttribute(type, "alt")} decoding="async" loading="lazy"${addAttribute(icon.src, "src")} width="53" height="53"> </div> <div class=""> <a${addAttribute(url, "href")} class="practice-button w-button hover:bg-primaryC hover:text-secondaryC transition-all duration-1000">View More</a> </div> </div> </div> </div>`;
...
const $$BlogSection = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${AllPosts && AllPosts.length > 0 && renderTemplate`${renderComponent($$result, "FeaturedBlogLayout", $$FeaturedBlogLayout, {}, { "default": ($$result2) => renderTemplate`${mostRecent && renderTemplate`${renderComponent($$result2, "FeaturedBlogSection", $$FeaturedBlogSection, { ...mostRecent.frontmatter, "url": mostRecent.url })}`}` })}
    ${maybeRenderHead()}<div class="blog-section"><div class="container w-container"><div class="blog-content-wrap"><div class="w-dyn-list" role="list"><!-- blog here -->${recentPosts && recentPosts.length > 0 && recentPosts.map(
