/* empty css                          */
import { d as createAstro, c as createComponent, r as renderTemplate, m as maybeRenderHead, e as addAttribute, f as renderComponent, g as renderSlot } from '../astro_BD0Lb4GF.mjs';
import 'kleur/colors';
import { $ as $$Index, a as $$BannerTitleSeparator, b as $$BaseLayout } from './_page__BKngyi8y.mjs';
import 'clsx';
...
const $$Version2 = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<div class="consultation-section lg:pt-0 overflow-hidden"> <div class="container w-container"> <div class="consultation-wrap"> <div class="w-layout-grid consultation-grid"> <!-- <div class="flex flex-col lg:flex-row"> --> <div class="consultation-intro-wrap"> <div class="section-title-left childrenFadeInFromBottomTag"> <h2 class="section-left-title-text fadeOutIntoBottom ">${title}</h2> <img src="/assets/icons/small-separator-gold.svg" loading="lazy" alt="Call For Consultation" class="w-[95px] h-[44px] fadeOutIntoBottom !delay-[250ms]"> <p class="section-left-content fadeOutIntoBottom !delay-[500ms]">${leftContent}<br></p> </div> <div class="consultation-button-wrap"> <a href="/contact" class="button w-button hover:bg-transparent hover:text-primaryC transition-all duration-1000 w-fit">Get in touch!</a> </div> </div> <div class="relative mx-auto lg:ml-0 sm:h-[560px] w-full my-10 childrenFadeInFromBottomTag"> ${renderComponent($$result, "EliHeadshot", $$EliHeadshot, { "wrapperStyle": "sm:absolute bg-transparent z-[1] sm:h-[400px] md:left-[75px] min-[991px]:left-0 min-[991px]:translate-x-[0px] fadeOutIntoBottom", "imgStyle": `object-fit w-[300px] h-[300px] min-[400px]:w-[400px] min-[400px]:h-[400px] ${responsiveSize} mx-auto block`, "immediateLoading": false })} <div${addAttribute(`hidden sm:block absolute rounded-full overflow-hidden w-[300px] h-[300px] fadeOutIntoBottom
...
export { $$ResponsiveImage as $, $$ListComponent as a, $$PracticeAreaLayout as b, $$EliHeadshot as c, $$Version2 as d, $$CourthouseCorner as e, criminalDefenseLaw as f };
