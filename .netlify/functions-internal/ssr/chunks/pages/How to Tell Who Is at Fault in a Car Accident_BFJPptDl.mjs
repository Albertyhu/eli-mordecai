/* empty css                          */
import { c as createComponent, r as renderTemplate, m as maybeRenderHead, d as addAttribute, e as createAstro, f as renderComponent, u as unescapeHTML, F as Fragment, g as renderSlot, h as renderHead } from '../astro_Dvw0weLc.mjs';
import 'kleur/colors';
import 'clsx';
/* empty css                                 */
/* empty css                                 */
...
const $$BaseLayout = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate(_a || (_a = __template(['<html lang="en"> <head><meta charset="utf-8"><title>', "</title>", '<meta content="width=device-width, initial-scale=1" name="viewport">', "", "<noscript></noscript>", "", '</head> <link href="/assets/icons/favicon.webp" rel="shortcut icon" type="image/x-icon"> ', " <body> ", " ", " ", " ", ' <!-- logic for nav bar --> <script src="/script/nav-script.js" type="text/javascript"><\/script> <script src="/script/animated_script.js" type="text/javascript"><\/script> </body> </html>'])), pageTitle, renderComponent($$result, "SEO", $$SEO, { "title": pageTitle, "description": customDescription }), homePage ? renderTemplate`<link href="/style/home.css" rel="stylesheet" type="text/css" media="print" onload="this.media='all'; this.onload=null;">` : renderTemplate`<link href="/style/global.css" rel="stylesheet" type="text/css" media="print" onload="this.media='all'; this.onload=null;">`, maybeRenderHead(), homePage ? renderTemplate`<link rel="stylesheet" href="/style/home.css">` : renderTemplate`<link rel="stylesheet" href="/style/global.css">`, renderHead(), renderComponent($$result, "ViewTransitions", $$ViewTransitions, {}), renderComponent($$result, "MinimizedNav", $$MinimizedNav, {}), renderComponent($$result, "MobileMenu", $$MobileMenu, {}), renderSlot($$result, $$slots["default"]), renderComponent($$result, "Footer", $$Index$1, {}));
...
const $$MarkdownPostLayout = createComponent(async ($$result, $$props, $$slots) => {
  ...
  let allAuthors = [];
  try {
    allAuthors = await Astro2.glob(/* #__PURE__ */ Object.assign({"../pages/author_profile/eli_mordecai.md": () => import('./eli_mordecai_Bl5rEXOI.mjs')}), () => "../pages/author_profile/*.md");
  } catch (e) {
    allAuthors = [];
  }
...
export { $$MarkdownPostLayout as $, BusinessInfo as B, GetTheMostRecentBlogs as G, How_to_Tell_Who_Is_at_Fault_in_a_Car_Accident as H, $$Index as a, $$BaseLayout as b, $$ResponsiveImage as c, filterPostsByAuthor as d, $$ProfilePicture as e, formatPhone as f, getPaginatedArray as g, createStaticPathArray as h };
